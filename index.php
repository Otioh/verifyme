                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase animated bounceInDown">Best Verification Services</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Safe & Secure For Your Organization</h1>
            
<form action="detail.php" method="get">
    <input class="form-control" placeholder="Enter Verification Code" name="code" />
    <button type="submit"  class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Verify Now</button>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-7">
                    <div class="mb-4">
                        ...
                        <h1 class="display-5 mb-0">We Offers Quality Verification Systems & Services</h1>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                            <div class="bg-primary d-flex flex-column justify-content-center text-center border-bottom border-5 border-secondary rounded p-3" style="height: 200px;">
                                ...
                                <h4 class="text-white mb-0">5 Years Experience</h4>
                            </div>
                        </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                ...
                <h1 class="display-5 mb-0">Our Excellent Verification Services</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item bg-light border-bottom border-5 border-primary rounded">
                        <div class="position-relative p-5">
                            ...
                            <h5 class="text-primary mb-0">Official</h5>
                            <h3 class="mb-3">ID Cards</h3>
                            <p>We design and print ID cards for Organizations</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="service-item bg-light border-bottom border-5 border-primary rounded">
                        <div class="position-relative p-5">
                            ...
                            <h5 class="text-primary mb-0">Online</h5>
                            <h3 class="mb-3">Identity Verification System</h3>
                            <p>We provide you with an online (24/7) Verification system to verify all ID card holder</p>
                            <a href="">Read More<i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div class="service-item bg-light border-bottom border-5 border-primary rounded">
                        <div class="position-relative p-5">
                            ...
                            <h3 class="mb-3">Biometric Verification</h3>
